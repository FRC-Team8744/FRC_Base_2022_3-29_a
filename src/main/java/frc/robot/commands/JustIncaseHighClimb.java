...
public class JustIncaseHighClimb extends SequentialCommandGroup {
  /**
   ...
   */
  public JustIncaseHighClimb(HookArm this_hookarm, HookElevator this_elevator, ArmLift this_ArmLift) {
