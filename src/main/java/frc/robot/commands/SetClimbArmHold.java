 ...
 */
public class SetClimbArmHold extends CommandBase {
  ...
  // private double angleToleranceDegrees = 2.0;  // Move to Constants, +/- range to check if arm moved to the right angle
...
/**
   ...
   */
public SetClimbArmHold(double this_angle, HookArm this_arm) {
  ...
  public void initialize() {
    m_hookarm.setCurrentLimit(Constants.HIGH_CURRENT_LIMIT);  // CAUTION: HIGH POWER ENABLED!
    ...
    m_hookarm.setPositionGoal(positionArmGoal, 1);
  }
  ...
  public void end(boolean interrupted) {
    // Disable motor
    m_hookarm.stopMotor();  // NEVER COMMENT THIS OUT! The motor will burn!

    // Reset current limit to lower threshold
  ...
  public boolean isFinished() {
    ...
    if (System.currentTimeMillis() - timeCommandStarted > 3000) return true;  // NEVER COMMENT THIS OUT! The motor will burn!
